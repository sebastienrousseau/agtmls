...
place by uninstall. The lockfile goes once nothing it records remains, and so
does any skills, commands or agents directory uninstall emptied, and the
...
with the `Generated by AgtMLS` header.
